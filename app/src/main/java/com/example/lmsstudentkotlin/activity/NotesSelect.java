...
public class NotesSelect extends AppCompatActivity {
...
//    private var requestQueue: RequestQueue? = null
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notes_select);


        spinnerAubN = findViewById(R.id.spinnerAubN);
        ...
        buttonCLick.setOnClickListener(v -> {
            if(subSelectId!="0"){
                Intent intent = new Intent(NotesSelect.this, Notes.class);
...
//        spinnerSub = findViewById(R.id.spinnerSub);
        ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(NotesSelect.this, R.layout.spinner_layout_background, subName);
