...
public class LiveClassSelect extends AppCompatActivity {
...
//    private var requestQueue: RequestQueue? = null
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_live_class_select);

        spinnerAubN = findViewById(R.id.spinnerAubLive);
        buttonCLick = findViewById(R.id.buttonCLickLive);
        ...
        buttonCLick.setOnClickListener(v -> {
            if(subSelectId!="0"){
                Intent intent = new Intent(LiveClassSelect.this, LiveClass.class);
...
//        spinnerSub = findViewById(R.id.spinnerSub);
        ArrayAdapter<String> dataAdapter1 = new ArrayAdapter<String>(LiveClassSelect.this, R.layout.spinner_layout_background, subName);
